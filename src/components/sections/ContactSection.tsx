            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <h2 className="text-4xl md:text-6xl font-display font-black text-white mb-6 leading-[1.1]">
                        Mari Kita Bangun <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-cyan-400">Sesuatu yang Luar Biasa.</span>
                    </h2>

                    <p className="text-gray-400 text-lg mb-10 max-w-lg leading-relaxed">
                        Jika Anda memiliki pertanyaan, ide proyek, atau sekadar ingin berdiskusi seputar pengembangan aplikasi web & mobile, silakan hubungi saya. Saya akan merespons secepat mungkin.
                    </p>
                    ...
                    <div className="flex flex-col gap-8 text-gray-300">
                        <div className="flex items-center gap-6 group cursor-pointer">
                            ...
                            <div>
                                ...
                                <a href="mailto:hartantofauzi14@gmail.com" className="text-gray-400 hover:text-cyan-400 transition-colors">hartantofauzi14@gmail.com</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-6 group cursor-pointer">
                            ...
                            <div>
                                <h4 className="font-bold text-white mb-1">Lokasi</h4>
                                <p className="text-gray-400 group-hover:text-cyan-400 transition-colors">Kab. Kulon Progo, DI Yogyakarta</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="relative z-10 flex flex-col gap-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                                <label htmlFor="name" className="text-sm font-semibold text-gray-400 ml-1">Nama Anda</label>
                                <input
                                    type="text"
                                    id="name"
                                    required
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="email" className="text-sm font-semibold text-gray-400 ml-1">Email Anda</label>
                                <input
                                    type="email"
                                    id="email"
                                    required
                        ...
                        <div className="flex flex-col gap-2">
                            <label htmlFor="subject" className="text-sm font-semibold text-gray-400 ml-1">Subjek</label>
                            <input
                                type="text"
                                id="subject"
                                required
                                placeholder="Pengembangan Aplikasi Mobile / Web"
                                className="w-full bg-dark-300/80 border border-gray-800 rounded-2xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-primary-500/30 transition-all"
                            />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label htmlFor="message" className="text-sm font-semibold text-gray-400 ml-1">Pesan</label>
                            <textarea
                                id="message"
                                required
                                rows={5}
