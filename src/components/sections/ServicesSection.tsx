        ...
        <section ref={containerRef} className="content-section container mx-auto px-4 max-w-6xl py-24 relative">
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {services.map((service: any, index: number) => {
                    ...
                    return (
                        <div key={index} className="service-card group relative p-8 rounded-3xl bg-dark-200/50 backdrop-blur-md border border-gray-800 hover:border-primary-500/50 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:-translate-y-1 overflow-hidden flex flex-col h-full">
