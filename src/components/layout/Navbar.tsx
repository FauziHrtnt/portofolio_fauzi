            ...
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <Link to="/" className="flex items-center gap-3 text-xl font-display font-bold tracking-tight text-gray-900 dark:text-white group">
                        <span>Fauzi Hartanto<span className="text-primary-500">.</span></span>
                    </Link>
                </div>

                <nav className="hidden md:flex items-center gap-2 ml-auto mr-8">
                    <Link to="/" className="text-base font-medium px-4 py-2 rounded-full hover:bg-white/10 dark:hover:bg-white/5 hover:text-primary-400 transition-all duration-300">Beranda</Link>
                    <Link to="/projects" className="text-base font-medium px-4 py-2 rounded-full hover:bg-white/10 dark:hover:bg-white/5 hover:text-primary-400 transition-all duration-300">Proyek</Link>
                    <Link to="/skills" className="text-base font-medium px-4 py-2 rounded-full hover:bg-white/10 dark:hover:bg-white/5 hover:text-primary-400 transition-all duration-300">Keahlian</Link>
                </nav>
