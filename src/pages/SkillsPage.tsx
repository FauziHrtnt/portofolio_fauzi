...
const SkillsPage: React.FC = () => {
    ...
    return (
        <div className="relative min-h-[calc(100vh-4rem)] bg-dark-300 w-full" ref={containerRef}>
            <Helmet>
                <title>Fauzi Hartanto - Keahlian & Teknologi</title>
                <meta name="description" content="Keahlian teknis dan tumpukan teknologi (tech stack) Fauzi Hartanto — PHP, Java, Python, SQL, dan Pengembangan Android." />
                <link rel="canonical" href="https://github.com/FauziHrtnt/skills" />
                <meta property="og:title" content="Fauzi Hartanto - Keahlian & Teknologi" />
                <meta property="og:description" content="Keahlian teknis dan tumpukan teknologi (tech stack) Fauzi Hartanto — PHP, Java, Python, SQL, dan Pengembangan Android." />
                <meta property="og:url" content="https://github.com/FauziHrtnt/skills" />
            </Helmet>
            ...
            <div className="relative z-10 w-full container mx-auto px-4 py-16">
                <div className="mb-16 text-center md:text-left max-w-3xl">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400">
                        Saya membangun sistem yang tangguh dan terukur di seluruh tumpukan teknologi menggunakan bahasa pemrograman dan alat bantu standar industri.
                    </p>
                </div>
