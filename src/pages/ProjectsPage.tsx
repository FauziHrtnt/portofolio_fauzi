...
const categories = [
    { label: 'Semua', value: ALL_FILTER_TYPE },
    { label: 'Aplikasi Android', value: ANDROID_FILTER_TYPE },
    { label: 'Situs & Aplikasi Web', value: WEBSITES_FILTER_TYPE },
];
...
const ProjectsPage: React.FC = () => {
    ...
    return (
        <div className="relative min-h-[calc(100vh-4rem)] bg-dark-300 w-full" ref={containerRef}>
            <Helmet>
                <title>Fauzi Hartanto - Proyek</title>
                <meta name="description" content="Lihat karya unggulan oleh Fauzi Hartanto — Aplikasi Android, sistem Web, dan model desain CAD 3D." />
                <link rel="canonical" href="https://github.com/FauziHrtnt/projects" />
                <meta property="og:title" content="Fauzi Hartanto - Proyek" />
                <meta property="og:description" content="Lihat karya unggulan oleh Fauzi Hartanto — Aplikasi Android, sistem Web, dan model desain CAD 3D." />
                <meta property="og:url" content="https://github.com/FauziHrtnt/projects" />
            </Helmet>
            ...
            <div className="relative z-10 w-full px-6 md:px-12 lg:px-16 py-16 max-w-[1600px] mx-auto">
                <div className="mb-12 text-center md:text-left">
                    <h1 className="text-4xl md:text-5xl font-display font-bold text-gray-900 dark:text-white mb-4">
                        Portofolio Proyek
                    </h1>
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
                        Koleksi aplikasi tangguh dan sistem kompleks yang telah saya arsitekturi dan bangun selama beberapa tahun terakhir.
                    </p>
                </div>
                                        ...
                                        <div className="flex justify-between items-center mb-4 relative z-10">
                                            {project.link && (
                                                <a href={project.link} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-gray-500 hover:text-white transition-colors bg-dark-100 px-3 py-1.5 rounded-md border border-gray-800 text-sm">
                                                    ...
                                                    {project.link.includes('github.com') ? 'Repositori' : 'Kunjungi'}
                                                </a>
                                            )}
